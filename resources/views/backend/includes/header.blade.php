    ...
    <div class="sa-toolbar__body">
        ...
        <div class="sa-toolbar__item dropdown">
            <button
                ...
                aria-expanded="false"
            >
                <img src="{{ asset('/') }}backend-assets/vendor/flag-icons/24/DE.png" class="sa-language-icon" alt="" />
            </button>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton3">
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="{{ asset('/') }}backend-assets/#">
                        <img src="{{ asset('/') }}backend-assets/vendor/flag-icons/24/DE.png" class="sa-language-icon me-3" alt="" />
                        <span class="ps-2">German</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="{{ asset('/') }}backend-assets/#">
                        <img src="{{ asset('/') }}backend-assets/vendor/flag-icons/24/FR.png" class="sa-language-icon me-3" alt="" />
                        <span class="ps-2">French</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="{{ asset('/') }}backend-assets/#">
                        <img src="{{ asset('/') }}backend-assets/vendor/flag-icons/24/GB.png" class="sa-language-icon me-3" alt="" />
                        <span class="ps-2">English</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="{{ asset('/') }}backend-assets/#">
                        <img src="{{ asset('/') }}backend-assets/vendor/flag-icons/24/RU.png" class="sa-language-icon me-3" alt="" />
                        <span class="ps-2">Russian</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="{{ asset('/') }}backend-assets/#">
                        <img src="{{ asset('/') }}backend-assets/vendor/flag-icons/24/IT.png" class="sa-language-icon me-3" alt="" />
            ...
            <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="dropdownMenuButton2">
                <div class="sa-notifications">
                    <div class="sa-notifications__header">
                        ...
                        <a class="sa-notifications__header-action" href="{{ asset('/') }}backend-assets/">Mark All as Read</a>
                    </div>
                    <ul class="sa-notifications__list">
                        <li class="sa-notifications__item">
                            <a href="{{ asset('/') }}backend-assets/#" class="sa-notifications__item-button">
                    ...
                    <div class="sa-notifications__footer"><a class="sa-notifications__footer-action" href="{{ asset('/') }}backend-assets/">See all 15 notifications</a></div>
                </div>
            </div>
        </div>
        <div class="dropdown sa-toolbar__item">
            ...
            >
                <span class="sa-toolbar-user__avatar sa-symbol sa-symbol--shape--rounded">
                    <img src="{{ asset('/') }}backend-assets/images/customers/customer-4-64x64.jpg" width="64" height="64" alt="" />
                </span>
            ...
            <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton">
                <li><a class="dropdown-item" href="{{ asset('/') }}backend-assets/#">Profile</a></li>
                <li><a class="dropdown-item" href="{{ asset('/') }}backend-assets/app-inbox-list.html">Inbox</a></li>
                <li><a class="dropdown-item" href="{{ asset('/') }}backend-assets/app-settings-toc.html">Settings</a></li>
                <li><hr class="dropdown-divider" /></li>
                <li><a class="dropdown-item" href="{{ asset('/') }}backend-assets/auth-sign-in.html">Sign Out</a></li>
            </ul>
        </div>
    </div>

...
<div class="sa-app__sidebar">
    <div class="sa-sidebar">
        <div class="sa-sidebar__header">
            <a class="sa-sidebar__logo" href="{{ asset('/') }}backend-assets/index.html">
                <!-- logo -->
                ...
                <li class="sa-nav__section">
                    ...
                    <ul class="sa-nav__menu sa-nav__menu--root">
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                            <a href="{{ asset('/') }}backend-assets/index.html" class="sa-nav__link">
                        ...
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                            <a href="{{ asset('/') }}backend-assets/" class="sa-nav__link" data-sa-collapse-trigger="">
                                <span class="sa-nav__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                                        <path
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                <li class="sa-nav__menu-item">
                                    <a href="{{ asset('/') }}backend-assets/app-settings-toc.html" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Table of Content</span>
                                    </a>
                                </li>
                                <li class="sa-nav__menu-item">
                                    <a href="{{ asset('/') }}backend-assets/app-settings-form.html" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>

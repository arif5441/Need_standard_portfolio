        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-6 col-xl-4">
                <div class="footer-item">
                    ...
                    <p class="mb-4">Need Standard Ltd. is transforming industries through innovative digital solutions in 
                ...
                <div class="footer-item">
                    ...
                    <p class="mb-4">Rahmania International Complex 28/1/C Toyenbee Circular Road, Level#12, Room#12, Motijheel C/A Dhaka-1000</p>
                </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-4">
                <div class="footer-item">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <p class="text-white mb-0">ecomnsl@gmail.com</p>
                    </div>
                    <div class="d-flex align-items-center">

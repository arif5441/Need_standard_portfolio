            ...
            <div class="row g-5 align-items-center">
                <div class="col-xl-7 wow fadeInLeft" data-wow-delay="0.2s">
                    <div>
                        ...
                        <p class="font-14">
                            Need Agro Farm is a distinctive farm dedicated to producing high-quality eggs while embracing the
                            charm of a heritage site.
                        </p>
                        <p class="font-14">
                            Designed as a perfect blend of agricultural innovation and cultural preservation,
                            the farm offers visitors an immersive experience that connects them to the region's rich traditions.
                            Its serene and picturesque environment, combined with its commitment to sustainable farming, makes
                            it a unique destination for day tours.
                        </p>
                        <p class="font-14">
                            The farm’s design draws inspiration from traditional architecture, with heritage-style buildings,
                            ...
                            while enjoying the rustic beauty of the surroundings. Guided tours provide a hands-on experience,
                            offering insights into sustainable poultry farming and the importance of fresh, high-quality produce.
                        </p>
                        <p class="font-14">
                            Need Agro Farm is also an ideal place to relax and reconnect with nature. Visitors
                            can stroll through scenic pathways, enjoy local refreshments, and soak in the peaceful atmosphere.
                ...
                <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
                    <div class="bg-primary rounded position-relative overflow-hidden">
                        <img src="{{ asset('/') }}frontend-assets/images/firm-side-image.png" class="img-fluid rounded w-100" alt="">
                    </div>
                </div>
            </div>
        </div>
